document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadData() {
        ...
        if (data) {
            try {
                ...
                if(parsed.inNu !== undefined) inNu.value = parsed.inNu;
    ...
    function calculate() {
        ...
        const nu_m2s_input = parseFloat(inNu.value) || 0;
    ...
    function animateParticles() {
        ...
        particles.forEach(p => {
            ...
            p.x += p.baseSpeed * (isTurbulent ? 4 : (isTransition ? 2 : 1.2));
            if (p.x > 105) p.x = -5;
